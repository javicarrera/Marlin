...
#define STRING_CONFIG_H_AUTHOR "(Javi Carrera, Marlin bugfix 2.1.x)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "JCA TronXY" //JAVI

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "512f45da-bb71-4bc3-b9ba-fe348891ae41" //JAVI
...
#define TEMP_SENSOR_BED 11 // 220VAC bed 100K 3950
 ...
 */
#define Z_MIN_PROBE_PIN P0_10 //JAVI
...
//Move slowly down until just fits one paper between nozzle and bed, note the height eg. -1.7
//M851 Z-1.7 to set offset you got in the previous step
//M211 S1 - Switch on soft endstops
//M500 stores in EEPROM
//You can write this offset here to have it fixed
//JAVI
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  //#define MIN_SOFTWARE_ENDSTOP_Z //JAVI comment for BLTOUCH
...
M851#define AUTO_BED_LEVELING_UBL
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 3      //JAVI Don't use more than 15 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 40, 10, 10, 10 } // (mm) Left, Front, Right, Back insets
...
// Also for Bigtreetech TFT24 v1.1 (12864 simulation mode) 
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN              P1_25 // LED driving pin SKR 1.4 JAVI
  ...
  #define NEOPIXEL_BKGD_INDEX_FIRST   7 // Index of the first background LED
  #define NEOPIXEL_BKGD_INDEX_LAST    11 // Index of the last background LED
